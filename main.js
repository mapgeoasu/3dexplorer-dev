...
require([
...
], function (Map, SceneView, WebScene, SceneLayer, Query, Home, Extent) {
  ...
  var cabTitle = "cabinet_shelves_file_v5";
  ...
  var table = new Tabulator("#drawers-table", {
    ...
    groupHeader: function (value, count, data, group) {
      if (value < 241) {
        ...
        return (
          "Cabinet Drawer: " + value + "<span style='color:#8c1d40; margin-left:10px;'>(" + count + " items)</span>"
        );
      } else if (value >= 261) {
